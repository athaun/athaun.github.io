...
function setup() {
    ...
    chunkSize = Math.floor(windowWidth / blockSize) + 20;
...
function getColor(x, y) {
    let c = lerpColor(color(217, map(terrain[x][y], 0, 100, 60, 80), 90), color(281, map(terrain[x][y], 0, 100, 50, 70), 100), terrain[x][y] / 100);
